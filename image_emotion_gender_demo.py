...
EmotionName = ('angry', 'disgust', 'fear', 'happy', 'sad', 'surprise', 'neutral')

print_switch = 0     # 0:open  1:close
...
def predict(image_folder_path,emotion_kind):
	...
	for label in predicted_label:
		f.write(str(label) + '\n')
	f.close()
	return [true_cnt,total_cnt,face_cnt,total_accuracy,face_recog_ratio,recog_accuracy]
